...
impl Example {
    ...
    fn view(&self) -> Element<'_, ()> {
        ...
        let data = vec![(0.0, 3.0), (1.0, 8.0), (2.0, 5.0), (3.0, 9.0), (4.0, 6.0)];

        let props = ChartProps::new().title("Tooltip demo").show_tooltip(true);
        let content = column![
            iced_text("Chart bar demo tooltip").size(20),
