...
use iced_shadcn::{ScrollAreaProps, Theme, scroll_area};
...
impl Example {
    ...
    fn view(&self) -> Element<'_, ()> {
        ...
        for i in 1..=60 {
            list = list.push(iced_text(format!("Line {i}")).size(12));
        }

        let content = container(scroll_area(list, ScrollAreaProps::new(), theme))
