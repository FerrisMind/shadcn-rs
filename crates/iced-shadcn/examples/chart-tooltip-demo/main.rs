...
#[cfg(feature = "charts")]
use iced_shadcn::{ChartProps, LineChart, Theme, chart};
...
impl Example {
    ...
    fn view(&self) -> Element<'_, ()> {
        ...
        let points = vec![[0.0, 3.0], [1.0, 6.0], [2.0, 5.0], [3.0, 9.0], [4.0, 7.0]];

        let props = ChartProps::new().title("Line tooltip").show_tooltip(true);
        let content = column![
            iced_text("Chart tooltip demo").size(20),
