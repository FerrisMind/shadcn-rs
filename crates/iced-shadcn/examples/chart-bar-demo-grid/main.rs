...
#[cfg(feature = "charts")]
use iced_shadcn::{BarChart, ChartGrid, ChartProps, Theme, chart};
...
impl Example {
    ...
    fn view(&self) -> Element<'_, ()> {
        ...
        let data = vec![(0.0, 4.0), (1.0, 7.0), (2.0, 5.0), (3.0, 9.0), (4.0, 6.0)];

        let props = ChartProps::new()
            .title("Grid demo")
            .show_grid(ChartGrid::new(true, true));
        let content = column![
            iced_text("Chart bar demo grid").size(20),
