...
impl fmt::Display for LabelledVariant {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(match self.0 {
            ...
            SpinnerVariant::PromptCircular => "circular",
            SpinnerVariant::PromptClassic => "classic",
            SpinnerVariant::PromptPulse => "pulse",
            SpinnerVariant::PromptPulseDot => "pulse-dot",
            SpinnerVariant::PromptDots => "dots",
            SpinnerVariant::PromptTyping => "typing",
            SpinnerVariant::PromptWave => "wave",
            SpinnerVariant::PromptBars => "bars",
            SpinnerVariant::PromptTerminal => "terminal",
...
const VARIANTS: [LabelledVariant; 14] = [
    ...
    LabelledVariant(SpinnerVariant::PromptCircular),
    LabelledVariant(SpinnerVariant::PromptClassic),
    LabelledVariant(SpinnerVariant::PromptPulse),
    LabelledVariant(SpinnerVariant::PromptPulseDot),
    LabelledVariant(SpinnerVariant::PromptDots),
    LabelledVariant(SpinnerVariant::PromptTyping),
    LabelledVariant(SpinnerVariant::PromptWave),
    LabelledVariant(SpinnerVariant::PromptBars),
    LabelledVariant(SpinnerVariant::PromptTerminal),
    LabelledVariant(SpinnerVariant::PromptTextBlink),
    LabelledVariant(SpinnerVariant::PromptTextShimmer),
